...
- Dedup edits the first message while a fingerprint keeps recurring within the window, posts a fresh message at 10, 100 and 1000 occurrences, and escalates a warning still recurring after an hour to the error channel once. It is in-process by default.
