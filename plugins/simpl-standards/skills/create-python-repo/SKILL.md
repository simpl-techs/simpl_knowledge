...
After the generated project exists, if the repo must join `simpl_knowledge` workflows (`.agent/`, SKILL.md sync), use `repo-context-bootstrap` only **after explicit user confirmation**.
