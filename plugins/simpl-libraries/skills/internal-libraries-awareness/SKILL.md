...
- **Primary**: `~/.simpl_knowledge/cache/catalog.md` (same tree if you have a clone of `simpl-techs/simpl_knowledge` at `SIMPL_KNOWLEDGE_CACHE`).
...
`~/.simpl_knowledge/cache/plugins/<plugin-name>/skills/*/SKILL.md`
