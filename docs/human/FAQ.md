...
| Dove sono i file locali? | Cache marketplace: `~/.simpl_knowledge/cache`. Regole Cursor: `~/.cursor/rules/simpl-*.mdc`. Skill Codex: `~/.agents/skills`, `~/.codex/skills` + `~/.codex/AGENTS.md`. Instinct locali: `~/.claude/simpl-memory/<repo>/`. |
