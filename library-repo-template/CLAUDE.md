...
- **simpl-wide conventions** (commits, testing, code style): installed via `simpl-standards` plugin from the marketplace. If the plugin is missing, run `/plugin install simpl-standards@simpl`.
